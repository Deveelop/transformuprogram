  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat">
        <div className="absolute inset-0 bg-[#004d40] bg-opacity-60 z-0" />
        <div className="container mx-auto px-4 text-center text-white relative z-10">
          ...
          <div className="mt-12 max-w-2xl mx-auto">
            <div className="bg-[#d4af37] bg-opacity-50 rounded-lg p-8 backdrop-blur-sm">
              <div className="aspect-video bg-gray-800 rounded-lg flex items-center justify-center">
                <Image src='/elontom.png' alt='' width={600} height={500}/>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 bg-cover bg-center bg-no-repeat relative">
        <div className="absolute inset-0 bg-[#004d40] bg-opacity-80 z-0" />
        <div className="container mx-auto px-4 text-center text-white relative z-10">
      ...
      <section className="py-5 bg-[#004d40]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-8 text-white">
           How It Works
          </h2>
          <p className="text-xl mb-12 max-w-3xl mx-auto opacity-90">
           It is a six months investment plan with an extention possibility at investors discretion.
            With a well  structured system to get your money key you into this financial freedom.
          </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
            <div className="sm:w-full w-70 p-6 bg-white rounded-lg border shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-blue-500">Tom Zhu</h4>
                  <p className="text-sm text-gray-500">Zhu is an Executive Officer at Tesla, Inc. serving as the Senior Vice President of Automotive.</p>
                </div>
              </div>
            </div>
            ...
            <div className="sm:w-full w-70 p-6 bg-white rounded-lg border shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-green-500">Jenny Johnson</h4>
                  <p className="text-sm text-gray-500">CEO at Franklin Resources, Inc. also known as Franklin Templeton
United States </p>
                </div>
              </div>
            </div>
            ...
            <div className="sm:w-full w-70 p-6 bg-white rounded-lg border shadow-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="w-24  aspect-square rounded-full overflow-hidden ">
                  <Image src='/elonmusk.jpeg' alt='Gideon' className=' w-full h-full' width={100} height={100}/>
                </div>
                <div>
                  <h4 className="font-semibold text-purple-500">Elon Musk</h4>
                  <p className="text-sm text-gray-500">Elon Reeve Musk CEO of Tesla, SpaceX, Twitter, and xAI.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold">WhatsApp Messages Only</p>
                    <p>+14065032086</p>
            ...
            <div>
              ...
              <div className="space-y-4">
                   <a href="https://www.tiktok.com/@calliemccie" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
<svg
  ...
  >
    <path d="M12.75 2c.46 2.16 2.16 3.74 4.34 3.87v2.53c-1.14-.03-2.23-.37-3.17-.97v6.48c0 3.18-2.46 5.94-5.63 6.09A6.08 6.08 0 0 1 2.25 13.8c.02-3.3 2.71-6 6-6 .25 0 .5.02.75.05v2.6a3.42 3.42 0 0 0-.75-.07 3.46 3.46 0 0 0-3.46 3.46c0 1.87 1.53 3.4 3.4 3.4a3.46 3.46 0 0 0 3.46-3.46V2h2.1Z" />
                    ...
                    <span>TikTok: @teslacryptogrowth</span>
                  </a>
                <a href="https://www.facebook.com/" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
                  <Facebook className="w-6 h-6 text-blue-400" />
                  <span>Facebook: teslacryptogrowth</span>
                </a>
                <a href="https://www.youtube.com/" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
                  <Youtube className="w-6 h-6 text-red-500" />
                  <span>YouTube: @teslacryptogrowth</span>
                </a>
                <a href="https://www.instagram.com/" className="flex items-center gap-4 hover:text-blue-400 transition-colors">
                  <Instagram className="w-6 h-6 text-pink-500" />
                  <span>Instagram: @teslacryptogrowth</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#ffcd1b] to-green-900 text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            Your Crypto Investment Breakthrough Starts Now
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Don&#39;t wait another year to wish you had started. Take the journey today.
          </p>
          <button
      ...
      <footer className="bg-[#075326] text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">
            &copy; 2026 Tesla Crypto Growth. All rights reserved. Becoming the Best Version of Yourself.
          </p>
        </div>
      </footer>
